...
namespace geometric
{
    ...
    class Triangle:Shape
    {
        ...
        public override float getPerimeter()
        {
            float p = (Point.length(p1, p2) + Point.length(p1, p3) + Point.length(p2, p3)); 
            return p;
        }
        public override float getArea()
        {
            float p = (Point.length(p1, p2) + Point.length(p1, p3) + Point.length(p2, p3) ) / 2;
    ...
    class Parallelogram : ConvexQuadrangle
    {
        ...
        public override float getArea()
        {
            ConvexQuadrangle ABCD = new ConvexQuadrangle(p1, p2, p3, p4);
            return ABCD.getArea();
        }
    }
    ...
    class Square : Lozenge, IRectangle
    {
        ...
        void IRectangle.calculatePerimeter()
        {
            base.getPerimeter();
        }
        void IRectangle.calculateArea()
        {
    ...
    class Program
    {
        ...
        {   
            ...
            Console.WriteLine("Perimeter of triangle ABC is " + ABC.getPerimeter());
            Console.WriteLine("Area of triangle ABC is " + ABC.getArea());
            Console.WriteLine("Perimeter is " + ABCD.getPerimeter());
            Console.WriteLine("Area is " + ABCD.getArea());
        }
    }
}
